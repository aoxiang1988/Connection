...
public class SelfGridView extends GridView{
    ...
    public SelfGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            Log.e("bin1111.yang","not support vibrator");
        }
    ...
    private Runnable mLongClickRunnable = new Runnable() {
        ...
        @Override
        public void run() {
            if(TestViewPagerActivity._activity.getviewpageritem() == 2
                    && count == TestViewPagerActivity._activity.getviewpagercount()) {
                isDrag = true; //设置可以拖拽
    ...
    private void onStopDrag(){
        ...
        ((GridAdapter)this.getAdapter()).setItemHide(-1);
        removeDragImage();
    }
