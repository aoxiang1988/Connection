package com.example.myautoapplication.aspectcode;
...
public class PermissionAspect {
    ...
    private static final String POINTCUT_METHOD_PERMISS_CHECK = "execution(@com.example.myautoapplication.aspectcode.PermissionCheck * *(..) && @annotation(permissionCheck))";//所有方法已TakePhoto结尾的方法，这里的@annotation(permissionCheck) ，里面一定是首字母小写，否则失效
