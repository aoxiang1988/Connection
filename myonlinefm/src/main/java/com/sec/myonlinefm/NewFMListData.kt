...
class NewFMListData (context: Context) : ObserverListener {
    ...
    private var mCenterMap : MutableMap<Int?, MutableList<StationProgram?>?> ? = null
    ...
    override fun observerLiveRadioLocalUpData(mStations: MutableList<Station?>?, map: MutableMap<Int?, MutableList<StationProgram?>?>?) {
        this.mStations = mStations
        this.mMap = map
        mFMListData.makeLocationList(mStations,mMap, FMListData.TYPE_LOCAL)
    }

    override fun observerLiveRadioCenterUpData(mStations: MutableList<Station?>?, map: MutableMap<Int?, MutableList<StationProgram?>?>?) {
        this.mCenterStations = mStations
        this.mCenterMap = map
        mFMListData.makeLocationList(mCenterStations,mCenterMap, FMListData.TYPE_CENTER)
    }

    override fun observerUpDataDifferentInfo(mStations: MutableList<Station?>?, map: MutableMap<Int?, MutableList<StationProgram?>?>?) {
