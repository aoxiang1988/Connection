...
public class RefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private ImageView footer_iv_arrow;
    /**
     * 头部下拉刷新时状态的描述
     */
    private TextView tv_state;
    private TextView footer_tv_state;
    /**
     * 底部布局
     */
    ...
    private void initHeaderView() {
        ...
        iv_arrow = (ImageView) headerView.findViewById(R.id.refresh);
        tv_state = (TextView) headerView.findViewById(R.id.header_tv);
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.header, null);
        footerView.measure(0, 0);
        footerViewHeight = footerView.getMeasuredHeight();
        footerView.setPadding(0, -footerViewHeight, 0, 0);
        footer_iv_arrow = (ImageView) footerView.findViewById(R.id.refresh);
        footer_tv_state = (TextView) footerView.findViewById(R.id.header_tv);
