...
class CharacterParser {
    ...
    fun convert(str: String?): String? {
        ...
        if (ascii > 0 && ascii < 160) {
            result = ascii as String
        } else {
            for (i in pyvalue!!.size - 1 downTo 0) {
                if (pyvalue.get(i) <= ascii) {
                    result = pystr!!.get(i)
                    break
                }
            }
    ...
    companion object {
        private val pyvalue: IntArray? = intArrayOf(-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
        ...
        var pystr: Array<String?>? = arrayOf("a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
        ...
        private val characterParser: CharacterParser? = CharacterParser()
